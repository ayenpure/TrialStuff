...
[0.008595091197, 0.07195030833, 0.3114658445, 0.08470223407, 0.7080818553, 2.875365421, 0.7950051469, 
4.699989641, 9.426968317, 5.068565226, 9.969621042, 11.24439151, 10.13356762, 11.32271363, 11.40806585,]]
...
[ 0.00556398059, 0.04978788985, 0.3746067096, 0.05371956559, 0.4904780578, 3.130746864, 0.4974828281,
4.284639767, 19.62545364, 4.526889721, 22.24945243, 37.817057, 22.57691255, 37.82619223, 40.57211776,]] 
...
[0.005356172253, 0.03835546387, 0.2769217896, 0.01944581771, 0.369634839, 2.592278842, 0.5653246479,
2.736770461, 12.38219363, 4.750259425, 19.28937253, 36.83125021, 20.14097182, 38.16713881, 41.31275893,]]
...
axes.scatterplot(total, numpy.array(alaska[2]), color=([2]*len(total), colormap), size=size, opacity=0.5)
...
axes.scatterplot(total, numpy.array(voltar[2]), color=([2]*len(total), colormap), size=size, opacity=0.5)
...
axes.scatterplot(total, numpy.array(summit[2]), color=([2]*len(total), colormap), size=size, opacity=0.5)
